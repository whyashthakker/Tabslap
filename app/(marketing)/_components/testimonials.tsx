...
const featuredTestimonial = {
  body: "I stumbled upon this awesome new tool you made and let me tell you, it is one hoot of a product! I can't believe I can generate comments and viral scores in just seconds! You must have some serious AI skills. Well done, keep killing it! 😉",
  author: {
    name: "Beth Cufee",
    handle: "cfeedbackcom",
    imageUrl:
...
const testimonials: {
  ...
  [
    ...
    [
      {
        body: `This extension is a social saver, have been able to engage more with people on multiple platforms in a better way and much more frequently.`,
        author: {
          name: "Geeta Belani",
          handle: "geetabelani",
          imageUrl:
            "https://pbs.twimg.com/profile_images/960896970289278976/E3hvyGa9_400x400.jpg",
        },
      },
    ],
  ],
