    ...
    return (
        <div className="flex justify-center items-center bg-white p-4">
            <div className="max-w-6xl bg-white p-6 rounded-lg">
                ...
                <p>Olly provides an AI-driven social media engagement tool (&ldquo;the Product&rdquo;). The Product is accessible at olly.social and other domains and subdomains controlled by Us (collectively, &ldquo;the Website&rdquo;).</p>
