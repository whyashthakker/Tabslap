    ...
    return (
        <div className="flex justify-center items-center bg-white p-4">
            <div className="max-w-6xl bg-white p-6 rounded-lg">
                ...
                <p>Subject to these Terms of Service (this "Agreement"), Olly.social ("Olly", "we", "us", and/or "our") provides access to Olly's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.</p>
                ...
                <p>By signing up and using the services provided by Olly (referred to as the "Service"), you are agreeing to be bound by the following terms and conditions ("Terms of Service"). The Service is owned and operated by Olly ("Us", "We", or "Our").</p>

                <h2 className="text-lg font-semibold mb-2 mt-4">Description of Service</h2>
                <p>Olly provides an AI-driven social media engagement tool ("the Product"). The Product is accessible at olly.social and other domains and subdomains controlled by Us (collectively, "the Website").</p>
                ...
                <p>Questions or comments about the Website or these Terms of Service may be directed to our support team at yash@explainx.ai.</p>
