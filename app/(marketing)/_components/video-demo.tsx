...
export function VideoDemo() {
  ...
  return (
    <>
      <div
        className="group absolute inset-0 flex cursor-pointer items-center justify-center duration-500 hover:bg-white hover:bg-opacity-30 lg:rounded-2xl"
        onClick={() => {
          openModal();
      ...
      >
        <iframe
          ...
          src="https://www.youtube.com/embed/8VJTHIgxy1Q?autoplay=1"
          frameBorder="0"
