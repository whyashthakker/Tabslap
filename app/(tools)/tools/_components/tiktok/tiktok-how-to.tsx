...
const TikTokHowToUse = () => {
  return (
    <div className="container mx-auto p-4">
      <Card>
        <CardHeader>
          <h2 className="text-2xl font-bold">How to Use TikTok Video Sample Comment Generator</h2>
        </CardHeader>
        <CardContent>
          <ol className="list-decimal pl-6">
            ...
            <li className="mb-2">
              <strong>Preview the comment:</strong> After entering the username, comment, and (optionally) uploading a profile image, you&apos;ll see a preview of the TikTok comment displayed on the canvas.
            </li>
            <li>
