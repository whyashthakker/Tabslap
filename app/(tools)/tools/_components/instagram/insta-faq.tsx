        ...
        <CardContent>
          ...
          <div className="mb-6">
            ...
            <h3 className="text-lg font-bold mb-2">
              What is the Instagram Comment Generator?
            </h3>{" "}
            <p>
              {" "}
              The Instagram Comment Generator is a powerful online tool that
              allows you to create custom Instagram comments with a profile
              image and a simulated comment box. You can enter your desired
              username, comment text, and optionally upload a profile image, and
              the generator will render a realistic-looking Instagram comment on
              a canvas.{" "}
            </p>{" "}
          </div>{" "}
          <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <p>
              {" "}
              Absolutely! The Instagram Comment Generator is designed to create
              ...
              and overlay them onto your posts, creating a more engaging and
