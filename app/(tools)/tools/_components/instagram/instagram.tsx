...
const InstagramComment = () => {
  ...
  const handleDownload = () => {
    ...
    posthog.capture("Downloaded Instagram Comment");
  };
  ...
  return (
    <div className="container mx-auto p-4 mt-10">
      <Card>
        <CardHeader>
          <h2 className="text-2xl text-center font-bold">Free Instagram Comment Generator</h2>
        </CardHeader>
        <CardContent>
          <div className="flex">
            ...
            <div className="w-1/2 relative">
              <Image src="/image-tiktok.png" alt="Instagram Image" width={500} height={500} />
              <canvas
                ref={canvasRef}
                width={500}
                height={500}
